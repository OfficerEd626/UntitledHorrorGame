...
//////////////////////////////////////////////////////////////////////////
// AUntitledHorrorGameCharacter

AUntitledHorrorGameCharacter::AUntitledHorrorGameCharacter()
{
...
void AUntitledHorrorGameCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AUntitledHorrorGameCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUntitledHorrorGameCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AUntitledHorrorGameCharacter::Look);
	}
	else
	{
...
void AUntitledHorrorGameCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUntitledHorrorGameCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
